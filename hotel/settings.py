...
SECRET_KEY = 'django-insecure-ckre=%7gt!lz*x$l#9c22h+aygrc(lkgh!x)qp=bugg(yruyo4'
...
INSTALLED_APPS = [
    ...
    'crispy_bootstrap5', # For Tailwind/Bootstrap forms
...
TIME_ZONE = 'Asia/Almaty' # Kazakhstan time zone
